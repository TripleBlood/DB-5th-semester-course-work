...
<div class="shop-container">
    <h1>Запросы, ожидающие сборки</h1>
<#list model.requests as request>
    <h2>Закакзчик: ${request.user.name}</h2>
    <a>Заказ создан: ${request.creationDate}</a><br>
    <div class="buttona"><a href="/admin/requests/${request.id}">Перейти к заказу</a></div>
</#list><br>
</div>
</body>